...
N = 375                            # number of atoms
Nc = 500                           # number of correlation steps (a larger number gives a finer resolution)
dt = 0.0005                         # time interval in units of ps (its inverse is roughly the maximum frequency attainable)
omega = np.arange(0, 1000.5, 0.5)    # angular frequency in units of THz
...
fileName = "vacf.lammpstrj" #Read the dump file
