...
namespace VRTK
{
    ...
    public sealed class VRTK_AdaptiveQuality : MonoBehaviour
    {
        ...
        private void UpdateRenderScale()
        {
            ...
            bool isvalid = UnityEngine.XR.XRStats.TryGetGPUTimeLastFrame(out float gpuTimeLastFrame);
            frameTimeRingBuffer[frameTimeRingBufferIndex] = isvalid ? gpuTimeLastFrame : 0f;
        ...
        private void UpdateDebugVisualization()
        {
            ...
            bool isvalid = UnityEngine.XR.XRStats.TryGetGPUTimeLastFrame(out float gpuTimeLastFrame);
            float gpuTime = isvalid ? gpuTimeLastFrame : 0f;
            int lastFrameIsInBudget = interleavedReprojectionEnabled || gpuTime > singleFrameDurationInMilliseconds
                                      ? 0
                                      : 1;
